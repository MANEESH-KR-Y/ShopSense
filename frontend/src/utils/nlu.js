...
export const NLU = {
    ...
    parse: (text, products) => {
        ...
        if (lowerText.includes("checkout") || lowerText.includes("complete") || lowerText.includes("save order")) {
            return { intent: 'checkout' };
        }

        if (lowerText.includes("generate bill") || lowerText.includes("preview") || lowerText.includes("download") || lowerText.includes("print")) {
        ...
        if (lowerText.includes("quantity") || lowerText.startsWith("set") || lowerText.startsWith("change")) {

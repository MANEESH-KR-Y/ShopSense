        ...
        <div className="max-w-2xl mx-auto relative z-10 animate-fade-in-up">
          <div className="flex justify-between items-end mb-8 border-b border-[var(--color-brand-border)] pb-4">
            <div>
              ...
              <p className="text-[var(--color-brand-text-muted)] mt-1">
          ...
          <div className="card mb-8">
            ...
            <div className="space-y-3 max-h-[300px] overflow-y-auto custom-scrollbar pr-2">
              {notifications.length === 0 ? (
                <p className="text-[var(--color-brand-text-muted)] text-center py-4">
                ...
                notifications.map((notif) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      <h3
                        className={`font-bold ${notif.is_read ? 'text-[var(--color-brand-text-muted)]' : 'text-white'}`}
                      >
                        {notif.title}
                      </h3>
          ...
          <div className="card space-y-8">
            {message && (
              <div className="p-4 bg-green-500/10 border border-green-500/20 text-green-400 rounded-lg text-sm font-bold text-center">
                {message}
              </div>
            )}
            {error && (
              <div className="p-4 bg-red-500/10 border border-red-500/20 text-red-400 rounded-lg text-sm font-bold text-center">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleChangePassword} className="space-y-6">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2.5 bg-[var(--color-brand-surface)] border border-[var(--color-brand-border)] text-white hover:bg-[var(--color-brand-border)] rounded-xl font-bold text-sm transition-all"
                >

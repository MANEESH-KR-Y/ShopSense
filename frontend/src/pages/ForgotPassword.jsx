  ...
  return (
    <div className="min-h-screen grid place-items-center p-4">
      ...
      <div className="max-w-md w-full border border-[var(--color-brand-border)] p-10 bg-[var(--color-brand-surface)]/80 backdrop-blur-xl rounded-2xl shadow-2xl relative animate-fade-in-up">
        ...
        {error && (
          <div className="bg-red-500/10 text-red-400 p-3 rounded mb-4 text-center">{error}</div>
        )}
        {msg && (
          <div className="bg-green-500/10 text-green-400 p-3 rounded mb-4 text-center">{msg}</div>
        )}
        ...
        <div className="text-center mt-6 pt-6 border-t border-[var(--color-brand-border)]">
          <Link
            to="/login"
            className="text-[var(--color-brand-text-muted)] hover:text-white text-sm font-bold transition-colors"
          >
            ← Back to Login
          </Link>
        </div>

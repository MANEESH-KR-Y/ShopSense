    ...
    <div className="flex h-screen bg-[var(--color-brand-black)] text-[var(--color-brand-text)] font-sans overflow-hidden">
      ...
      <main className="flex-1 flex items-center justify-center p-8 relative">
        ...
        <div className="max-w-lg w-full card shadow-2xl relative z-10 animate-fade-in-up">
          ...
          {msg && (
            <div className="p-3 mb-4 text-green-400 bg-green-500/10 border border-green-500/20 rounded font-bold text-sm text-center">
              {msg}
            </div>
          )}
          {error && (
            <div className="p-3 mb-4 text-red-400 bg-red-500/10 border border-red-500/20 rounded font-bold text-sm text-center">
              {error}
            </div>
          )}

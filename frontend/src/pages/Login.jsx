  ...
  return (
    <div className="min-h-screen grid place-items-center p-4">
      ...
      <div className="max-w-md w-full border border-[var(--color-brand-border)] p-10 bg-[var(--color-brand-surface)]/80 backdrop-blur-xl rounded-2xl shadow-2xl relative animate-fade-in-up">
        ...
        {msg && (
          <div className="bg-green-500/10 text-green-400 text-sm font-medium p-4 mb-6 text-center border border-green-500/20 rounded-lg">
            {msg}
          </div>
        )}
          ...
          {loginMode === 'password' ? (
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-[var(--color-brand-text-muted)] font-bold text-xs uppercase tracking-widest ml-1">
                  Password
                </label>
                <Link
                  to="/forgot-password"
                  className="text-xs text-[var(--color-brand-blue)] hover:text-[var(--color-brand-blue-hover)] font-bold"
                >
                  Forgot?
                </Link>
              </div>
